...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto h-full duration-300 ease-linear">
        {/* <!-- Sidebar Menu --> */}
        <nav className="flex flex-col mt-5 py-4 px-4 lg:mt-9 lg:px-6 h-full">
          {/* <!-- Menu Group --> */}
          <h3 className="mb-4 ml-4 text-sm font-semibold text-bodydark2">
            MENÜ
          </h3>

          <ul className="mb-6 flex flex-col h-full gap-1.5">
            {/* <!-- Menu Item Profile --> */}
            <li>
              <NavLink
                to="/"
            ...
            <li>
              <NavLink
                to="/slaytlar"
                className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                  pathname.includes('slaytlar') && 'bg-graydark dark:bg-meta-4'
                }`}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <li>
              <NavLink
                to="/hizmetler"
                className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                  pathname.includes('hizmetler') && 'bg-graydark dark:bg-meta-4'
                }`}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
