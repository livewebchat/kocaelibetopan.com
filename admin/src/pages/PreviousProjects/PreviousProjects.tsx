...
const PreviousProjects = () => {
  ...
  const [currentPreviousProjects, setCurrentPreviousProjects] = useState<
    PreviousProject[]
  >([]);
  const [previousProjectForEdit, setPreviousProjectForEdit] =
    useState<PreviousProject>();
  ...
  const clearAddPreviousProjectForm = () => {
    setTitle('');
    setDescription('');
    setImages([]);
  };
    ...
    <>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-10">
        {loadingPreviousProjects ? (
          ...
          >
            {currentPreviousProjects.map((project) => (
              <SwiperSlide
                className="cursor-grab active:cursor-grabbing group"
                key={project.id}
              >
                <button
                  onClick={() => setPreviousProjectForEdit(project)}
                        ...
                        <div className="flex flex-col gap-4">
                          ...
                          <div className="flex gap-2 justify-end">
                            ...
                            <button
                              ...
                              onClick={() => {
                                handleDeletePreviousProject(project.id);
                                toast.dismiss(t.id);
                              }}
                            >
                              Sil
