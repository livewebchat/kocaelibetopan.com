  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-3 2xl:gap-7.5">
        <Card
          to="/slaytlar"
          description="Ana sayfa slaytları"
          title="Slaytlar"
        ...
        <Card
          to="/gecmis-projeler"
          description="Referans projeler"
          title="Geçmiş Projeler"
          className="text-primary dark:text-white"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <Card
          ...
          description="Telefon, E-posta, WhatsApp"
        ...
        <Card
          ...
          target="_blank"
          description="Müşteri gözünden siteyi görüntüle"
